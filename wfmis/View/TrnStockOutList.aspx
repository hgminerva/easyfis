<%@ Page Title="" Language="C#" MasterPageFile="~/Bootstrap.Master" AutoEventWireup="true" CodeBehind="TrnStockOutList.aspx.cs" Inherits="wfmis.View.TrnStockOutList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function CmdAdd_onclick() {
            location.href = 'TrnStockOutDetail.aspx';
        }
        function CmdEdit_onclick(Id) {
            if (Id > 0) {
                location.href = 'TrnStockOutDetail.aspx?Id=' + Id;
            }
        }
        function CmdDelete_onclick(Id) {
            if (confirm('Are you sure?')) {
                $.ajax({
                    url: '/api/TrnStockOut/' + Id,
                    cache: false,
                    type: 'DELETE',
        ...
        function RenderStockOutTable() {
            var StockOutTable = $("#StockOutTable").dataTable({
                "bServerSide": true,
                "sAjaxSource": '/api/TrnStockOut',
                "sAjaxDataProp": "TrnStockOutData",
                "bProcessing": true,
                "bLengthChange": false,
                ...
                "aoColumns": [
                        ...
                        { "mData": "OTDate", "sWidth": "120px" },
                        { "mData": "OTNumber", "sWidth": "120px" },
                        { "mData": "Particulars" },
                        {
        ...
        $(document).ready(function () {
            RenderStockOutTable()
            $("#StockOutTable").on("click", "input[type='button']", function () {
                var ButtonName = $(this).attr("id");
                var Id = $("#StockOutTable").dataTable().fnGetData(this.parentNode);
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div id="main-content">
        <div class="container">
            ...
            <div class="row">
                <div class="span12">
                    <table id="StockOutTable" class="table table-striped table-condensed">
                        <thead>
                            <tr>
                                <th colspan="1">
