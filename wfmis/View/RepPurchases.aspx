<%@ Page Title="" Language="C#" MasterPageFile="~/Bootstrap.Master" AutoEventWireup="true" CodeBehind="RepPurchases.aspx.cs" Inherits="wfmis.View.RepPurchases" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script type="text/javascript" charset="utf-8">
	    ...
	    // Events
	    function CmdViewPurchaseSummary_onclick() {
	        location.href = 'RepPurchases.aspx?tab1BranchId=' + $tab1BranchId + '&' +
	    ...
	    function CmdViewPurchaseDetail_onclick() {
	        location.href = 'RepPurchases.aspx?tab2BranchId=' + $tab2BranchId + '&' +
	    ...
	    function CmdViewPurchaseBook_onclick() {
	        location.href = 'RepPurchases.aspx?tab3BranchId=' + $tab3BranchId + '&' +
	    ...
	    function renderTablePurchaseSummary() {
	        ...
	        var tablePurchaseSummary = $("#tablePurchaseSummary").dataTable({
	            "sAjaxSource": '/api/RepPurchaseSummary?tab1DateStart=' + DateStart + '&tab1DateEnd=' + DateEnd + '&tab1PeriodId=' + $tab1PeriodId + '&tab1BranchId=' + $tab1BranchId,
	            "bPaginate": false,
	            "sAjaxDataProp": "RepPurchaseSummaryData",
	            "bLengthChange": false,
	            ...
	            "fnDrawCallback": function (oSettings) {
	                if (oSettings.aiDisplay.length == 0) {
	                    ...
	                    var nTrs = $('#tablePurchaseSummary tbody tr');
	    ...
	    function renderTablePurchaseDetail() {
	        var ds = new Date($tab2DateStart);
	        var de = new Date($tab2DateEnd);
	        var DateStart = ds.getFullYear() + "-" + (ds.getMonth() + 1) + "-" + ds.getDate();
	        var DateEnd = de.getFullYear() + "-" + (de.getMonth() + 1) + "-" + de.getDate();

	        var tablePurchaseDetail = $("#tablePurchaseDetail").dataTable({
	            "sAjaxSource": '/api/RepPurchaseDetail?tab2DateStart=' + DateStart + '&tab2DateEnd=' + DateEnd + '&tab2PeriodId=' + $tab2PeriodId + '&tab2BranchId=' + $tab2BranchId,
	            "bPaginate": false,
	            "sAjaxDataProp": "RepPurchaseDetailData",
	            "bLengthChange": false,
	            "sDom": '<"top"Tf>rt<"bottom"p><"clear">',
	            "oTableTools": {
	                "aButtons": [
	            ...
	            "aoColumns": [
                        {
                            "mData": "PurchaseInvoice", "bVisible": false,
                            "mRender": function (data) {
	                                        var n = data.indexOf(")");
	                                        var Link = data.substring(1, n);
	                                        var PurchaseInvoice = data.substring(n + 1, data.length);
	                                        return '<a href="' + Link + '">' + PurchaseInvoice + '</a>'
	                                    }
                        },
                        { "mData": "PIDate", "sWidth": "100px" },
                        {
	            ...
	            "fnDrawCallback": function (oSettings) {
	                if (oSettings.aiDisplay.length == 0) {
	                    ...
	                    var nTrs = $('#tablePurchaseDetail tbody tr');
	                    var iColspan = nTrs[0].getElementsByTagName('td').length;
	                    var sLastGroup = "";
	                    var group_Amount = 0;
	                    ...
	                    for (var i = 0; i < nTrs.length; i++) {
	                        var iDisplayIndex = oSettings._iDisplayStart + i;
	                        var sGroup = oSettings.aoData[oSettings.aiDisplay[iDisplayIndex]]._aData["PurchaseInvoice"];
	    ...
	    function renderTablePurchaseBook() {
	        var ds = new Date($tab3DateStart);
	        var de = new Date($tab3DateEnd);
	        var DateStart = ds.getFullYear() + "-" + (ds.getMonth() + 1) + "-" + ds.getDate();
	        var DateEnd = de.getFullYear() + "-" + (de.getMonth() + 1) + "-" + de.getDate();

	        var tablePurchaseBook = $("#tablePurchaseBook").dataTable({
	            "sAjaxSource": '/api/RepPurchaseBook?tab3DateStart=' + DateStart + '&tab3DateEnd=' + DateEnd + '&tab3PeriodId=' + $tab3PeriodId + '&tab3BranchId=' + $tab3BranchId,
	            "bPaginate": false,
	            "sAjaxDataProp": "RepPurchaseBookData",
	            "bLengthChange": false,
	            "sDom": '<"top"Tf>rt<"bottom"p><"clear">',
	            "oTableTools": {
	                "aButtons": [
	            ...
	            "fnDrawCallback": function (oSettings) {
	                if (oSettings.aiDisplay.length == 0) {
	                    ...
	                    var nTrs = $('#tablePurchaseBook tbody tr');
	                    var iColspan = nTrs[0].getElementsByTagName('td').length;
	                    var sLastGroup = "";
	    ...
	    $(document).ready(function () {
	        ...
	        initTab3();
	        // Render table
	        renderTablePurchaseSummary();
	        renderTablePurchaseDetail();
	        renderTablePurchaseBook();
            // Default tab
	        if ($tab1BranchId > 0) $('#tab a[href="#tabPurchaseSummary"]').tab('show');
	        if ($tab2BranchId > 0) $('#tab a[href="#tabPurchaseDetail"]').tab('show');
	        if ($tab3BranchId > 0) $('#tab a[href="#tabPurchaseBook"]').tab('show');
	    });
    ...
    <div id="main-content">
        <div class="container">
            ...
            <div id="tab" class="btn-group" data-toggle="buttons-radio">
              <a href="#tabPurchaseSummary" class="btn" data-toggle="tab" id="tab1">Purchase Summary</a>
              <a href="#tabPurchaseDetail" class="btn" data-toggle="tab" id="tab2">Purchase Detail</a>
              <a href="#tabPurchaseBook" class="btn" data-toggle="tab" id="tab3">Purchase Book</a>
            </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tabPurchaseSummary">
                    <div class="row-fluid">
                        <div class="span6">
                        ...
                        <div class="span6 text-right">
                            <input runat="server" id="CmdViewPurchaseSummary" type="button" class="btn btn-primary" value="View" onclick="CmdViewPurchaseSummary_onclick()"/>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-center">Purchase Summary</h3>
                        <table id="tablePurchaseSummary" class="table table-striped table-condensed" >
                            <thead>
                                <tr>
                                    <th>PI Date</th>
                                    <th>PI No.</th>
                            ...
                            <tbody id="tablebodyPurchaseSummary"></tbody>
                            <tfoot id="tablefootPurchaseSummary"></tfoot>
                        </table>
                    </div>
                </div>

                <div class="tab-pane" id="tabPurchaseDetail">
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Branch </label>
                        ...
                        <div class="span6 text-right">
                            <input runat="server" id="CmdViewPurchaseDetail" type="button" class="btn btn-primary" value="View" onclick="CmdViewPurchaseDetail_onclick()"/>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-center">Purchase Detail</h3>
                        <table id="tablePurchaseDetail" class="table table-striped table-condensed" >
                            <thead>
                                <tr>
                            ...
                            <tbody id="tablebodyPurchaseDetail"></tbody>
                            <tfoot id="tablefootPurchaseDetail"></tfoot>
                        </table>
                    </div>
                </div>

                <div class="tab-pane" id="tabPurchaseBook">
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                <label class="control-label">Branch </label>
                        ...
                        <div class="span6 text-right">
                            <input runat="server" id="CmdViewPurchaseBook" type="button" class="btn btn-primary" value="View" onclick="CmdViewPurchaseBook_onclick()"/>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-center">Purchase Book</h3>
                        <table id="tablePurchaseBook" class="table table-striped table-condensed" >
                            <thead>
                                <tr>
                                    <th>PurchaseInvoice</th>
                                    <th>Journal Date</th>
                            ...
                            <tbody id="tablebodyPurchaseBook"></tbody>
                            <tfoot id="tablefootPurchaseBook"></tfoot>
                        </table>
                    </div>
                </div>
