...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div id="main-content">
        <div class="container">
            ...
            <div class="row">
                <div class="span3"><a class="btn btn-success" href="MstSupplierList.aspx"><img src="/Images/buttons/Supplier.png" alt="Supplier" /></a></div>
                <div class="span3"><a class="btn btn-success" href="MstCustomerList.aspx"><img src="/Images/buttons/Customer.png" alt="Customer" /></a></div>
                <div class="span3"><a class="btn btn-success" href="MstItemList.aspx"><img src="/Images/buttons/Item.png" alt="Item" /></a></div>
                <div class="span3"><a class="btn btn-warning" href="/Account/Manage.aspx"><img src="/Images/buttons/Settings.png" alt="Settings" /></a></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="span3"><a class="btn btn-success" href="MstAccountList.aspx"><img src="/Images/buttons/ChartOfAccounts.png" alt="COA" /></a></div>
            ...
            <div class="row">
                <div class="span3"><a class="btn btn-success" href="MstUserStaffList.aspx"><img src="/Images/buttons/Users.png" alt="User" /></a></div>
                <div class="span3"><a class="btn btn-success" href="MstDiscountList.aspx"><img src="/Images/buttons/Discount.png" alt="Discount" /></a></div>
                <div class="span3"><a class="btn btn-success" href="SysFolders.aspx"><img src="/Images/buttons/SystemFolder.png" alt="SystemFolders" /></a></div>
                <div class="span3"><a class="btn btn-danger" href="SysUtilities.aspx"><img src="/Images/buttons/Utility.png" alt="SystemUtilities" /></a></div>
            </div>
