<%@ Page Title="" Language="C#" MasterPageFile="~/Bootstrap.Master" AutoEventWireup="true" CodeBehind="MstSupplierList.aspx.cs" Inherits="wfmis.View.MstSupplier" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function CmdDelete_onclick(Id) {
            if (confirm('Delete ' + easyFIS.getTableData($("#TableSupplier"), Id, "Id", "Supplier") + '?')) {
                $.ajax({
        ...
        function CmdAdd_onclick() {
            location.href = 'MstSupplierDetail.aspx';
        }

        // Render table
        function renderTableSupplier() {
        ...
        $(document).ready(function () {
            ...
            $("#TableSupplier").on("click", "input[type='button']", function () {
                var ButtonName = $(this).attr("id");
                var Id = $("#TableSupplier").dataTable().fnGetData(this.parentNode);
                    ...
                    <table id="TableSupplier" class="table table-striped table-condensed" >
                        <thead>
                            <tr>
                                ...
                                <th colspan="4" style="text-align:right">Supplier List</th>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
