<%@ Page Title="" Language="C#" MasterPageFile="~/Bootstrap.Master" AutoEventWireup="true" CodeBehind="TrnSalesOrderList.aspx.cs" Inherits="wfmis.View.TrnSalesOrderList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function CmdAdd_onclick() {
            location.href = 'TrnSalesOrderDetail.aspx';
        }
        function CmdEdit_onclick(Id) {
            if (Id > 0) {
                location.href = 'TrnSalesOrderDetail.aspx?Id=' + Id;
            }
        }
        ...
        function RenderSalesOrderTable() {
            var SalesOrderTable = $("#SalesOrderTable").dataTable({
                                        "bServerSide": true,
                                        "sAjaxSource": '/api/TrnSalesOrder',
                                        "sAjaxDataProp": "TrnSalesOrderData",
                                        "bProcessing": true,
                                        "bLengthChange": false,
                                        ...
                                        "aoColumns": [
                                                ...
                                                { "mData": "SODate", "sWidth": "120px" },
                                                { "mData": "SONumber", "sWidth": "120px" },
                                                { "mData": "Customer" },
                                                {
        ...
        $(document).ready(function () {
            ...
            $("#SalesOrderTable").on("click", "input[type='button']", function () {
                var ButtonName = $(this).attr("id");
                var Id = $("#SalesOrderTable").dataTable().fnGetData(this.parentNode);
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div id="main-content">
        <div class="container">
            ...
            <div class="row">
                <div class="span12">
                    <table id="SalesOrderTable" class="table table-striped table-condensed">
                        <thead>
                            <tr>
                                <th colspan="1"><input runat="server" id="CmdAdd" type="button" value="Add" class="btn btn-primary" onclick="CmdAdd_onclick()" /></th>
                                <th colspan="6" style="text-align: right">Sales Order</th>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
