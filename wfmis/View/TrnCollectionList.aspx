<%@ Page Title="" Language="C#" MasterPageFile="~/Bootstrap.Master" AutoEventWireup="true" CodeBehind="TrnCollectionList.aspx.cs" Inherits="wfmis.View.TrnCollectionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function CmdAdd_onclick() {
            location.href = 'TrnCollectionDetail.aspx';
        }
        function CmdEdit_onclick(Id) {
            if (Id > 0) {
                location.href = 'TrnCollectionDetail.aspx?Id=' + Id;
            }
        }
        function CmdDelete_onclick(Id) {
            if (confirm('Are you sure?')) {
                $.ajax({
                    url: '/api/TrnCollection/' + Id,
                    cache: false,
                    type: 'DELETE',
        ...
        $(document).ready(function () {
            ...
            CollectionTable = $("#CollectionTable").dataTable({
                "bServerSide": true,
                "sAjaxSource": '/api/TrnCollection',
                "sAjaxDataProp": "TrnCollectionData",
                "bProcessing": true,
                "bLengthChange": false,
                "iDisplayLength": 20,
                ...
                "aoColumns": [
                        ...
                        { "mData": "ORDate", "sWidth": "120px" },
                        { "mData": "ORNumber", "sWidth": "120px" },
                        { "mData": "Customer", "sWidth": "350px" },
                        { "mData": "Particulars" },
                        {
            ...
            $("#CollectionTable").on("click", "input[type='button']", function () {
                var ButtonName = $(this).attr("id");
                var Id = $("#CollectionTable").dataTable().fnGetData(this.parentNode);
    ...
    <div id="main-content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span12">
                    <table id="CollectionTable" class="table table-striped table-condensed" >
                        <thead>
                            <tr>
                                <th colspan="1"><input runat="server" id="CmdAdd" type="button" value="Add" class="btn btn-primary" onclick="CmdAdd_onclick()"/></th>
                                <th colspan="7" style="text-align:right">Collection</th>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
