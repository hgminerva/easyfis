<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Bootstrap.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="wfmis.Account.RegisterExternalLogin" %>
